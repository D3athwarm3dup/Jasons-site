        ...
        <section className="bg-[#2C2C2C] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-[#8C8277] text-lg mt-4 max-w-xl">
              Ready to start your project? Or just want to ask a few questions?
              Jason is happy to chat — no pressure.
            </p>
          </div>
        </section>

        {/* Content */}
        <section className="py-20 bg-[#FAF5EE]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <ul className="space-y-5">
                    {[
                      ...
                      },
                      {
                        ...
                        label: "Email",
                        value: "jason@norrisdeckingandheds.com.au",
                        href: "mailto:jason@norrisdeckingandheds.com.au",
                      },
                      {
                        icon: (
